...
//rendering the user info into the table
renderStudents();
...
studentForm.addEventListener("submit", function (event) {
  ...
  const age = parseInt(ageInput.value); //by default the input value is in String format
...
editButton.appendChild(img1);
  ...
  deleteButton.appendChild(img);
    ...
    degreeCell.appendChild(deleteButton);
